...
class UserControllerTest {
    ...
    void addNewUserCorrect() throws ValidationException {
        User user1 = new User("user1@yandex.ru", "login", "name", LocalDate.of(1990,12,28));
        uc.addNewUser(user1);
    }

    @Test
    void addNewSpaseLogin() throws ValidationException {
        User user1 = new User("user1@yandex.ru", "log in", "name", LocalDate.of(1950,12,28));
        uc.addNewUser(user1);
    }

    @Test
    void addNewBlankEmail() throws ValidationException {
        User user1 = new User(" ", "login", "name", LocalDate.of(1950,12,28));
        uc.addNewUser(user1);
    }

    @Test
    void addNewWithOutATEmail() throws ValidationException {
        User user1 = new User("user1yandex.ru", "login", "name", LocalDate.of(1950,12,28));
        uc.addNewUser(user1);
    }

    @Test
    void futureBirthday() throws ValidationException {
        User user1 = new User("user1@yandex.ru", "login", "name", LocalDate.of(3500,12,28));
        uc.addNewUser(user1);
    }
